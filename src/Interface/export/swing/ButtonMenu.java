...
public class ButtonMenu extends JButton {
    ...
    public void setIconName(String iconName) {
        ...
        setIcon(new ImageIcon(getClass().getResource("/Interface/export/icon/" + iconName + ".png")));
    }
    ...
    public void setSelected(boolean bln) {
        ...
        if (bln) {
            setIcon(new ImageIcon(getClass().getResource("/Interface/export/icon/" + iconName + "s.png")));
